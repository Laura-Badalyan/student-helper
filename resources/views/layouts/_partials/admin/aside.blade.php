<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
	...
	<div class="brand flex-column-auto" id="kt_brand" kt-hidden-height="65" style="">
		...
		<a href="/dashboard" class="brand-logo">
			<img alt="Մարտին Էլիզբարյան" src="/img/logo_white.svg" width="140px">
		</a>
		<!--end::Logo-->
		<!--begin::Toggle-->
	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 534px; overflow: hidden;">
			<!--begin::Menu Nav-->
			<ul class="menu-nav">
                ...
                <li class="menu-item @if( Request::route()->getName() == 'dashboard.pvp') menu-item-active @endif" aria-haspopup="true">
                    <a href="/dashboard/pvp" class="menu-link">
                        @include("svg.equalizer",["class" => "svg-icon svg-icon-2x menu-icon"])
                        <span class="menu-text">1 x 1</span>
                    </a>
                </li>
                ...
                <li class="menu-item @if( Request::route()->getName() == 'admin.groups.index') menu-item-active @endif" aria-haspopup="true">
                    <a href="/admin/groups" class="menu-link">
                        @include("svg.folder_play",["class" => "svg-icon svg-icon-2x menu-icon"])
                        <span class="menu-text">Groups</span>
                    </a>
                </li>

                <li class="menu-item @if( Request::route()->getName() == 'admin.courses.index') menu-item-active @endif" aria-haspopup="true">
                    <a href="/admin/courses" class="menu-link">
                        @include("svg.youtube",["class" => "svg-icon svg-icon-2x menu-icon"])
